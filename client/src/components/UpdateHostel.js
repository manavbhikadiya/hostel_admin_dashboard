          ...
          <div class="card-body">
            ...
            >
              ...
              <div class="col-md-6">
                ...
                <textarea class="form-control" id="hostel_description" name="description" value={initialData.description} onChange={handleData} rows="3">{initialData.description}</textarea>
              </div>
              <div class="col-12">
